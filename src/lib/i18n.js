  ...
  tr: {
    translation: {
      ...
      errors: {
        ...
        postCreateFailed: "Yazı oluşturulamadı",
        postUpdateFailed: "Yazı güncellenemedi",
        postDeleteFailed: "Yazı silinemedi",
        articleUnavailable: "Yazı şu anda yüklenemiyor",
        articleUnavailableHint: "İçerik servisi bu yazıyı getiremedi. Biraz sonra tekrar deneyebilirsin.",
        articleNotFound: "Bu yazı bulunamadı",
        articleNotFoundHint: "Bağlantı değişmiş veya içerik kaldırılmış olabilir. Keşfet sayfasından devam edebilirsin.",
      ...
      validation: {
        ...
        usernameFormat: "Yalnızca harf, rakam ve alt çizgi kullanın",
      },
      // Success messages
      success: {
      ...
      auth: {
        ...
        oauthError: "Google girişi tamamlanamadı. Lütfen tekrar deneyin.",
        oauthPending: "Kimliğin doğrulanıyor. Bu pencereyi kapatma.",
        ...
        sessionCheckSlowTitle: "Oturum kontrolü beklenenden uzun sürüyor",
        sessionCheckSlowMessage: "Bağlantı yavaş olabilir. Oturum kontrolünü açık bırakabilir veya giriş sayfasına devam edebilirsiniz.",
        continueToLogin: "Giriş sayfasına devam et",
      ...
      footer: {
        ...
        connect: "Bağlantı",
        github: "GitHub",
        description: "Kanıtı, güncelliği ve uygulama bağlamıyla birlikte tutulan pratik teknoloji bilgisi.",
  ...
  en: {
    translation: {
      ...
      errors: {
        ...
        articleUnavailable: "This story is temporarily unavailable",
        articleUnavailableHint: "The content service could not load this story. Try again in a moment.",
        articleNotFound: "This story could not be found",
        articleNotFoundHint: "The link may have changed or the story may have been removed. Continue from Explore.",
      ...
      auth: {
        ...
        oauthPending: "We are verifying your identity. Keep this window open.",
        ...
        sessionCheckSlowTitle: "Session check is taking longer than expected",
        sessionCheckSlowMessage: "Your connection may be slow. You can keep this check open or continue to the login page.",
      ...
      footer: {
        ...
        connect: "Connect",
        github: "GitHub",
        description: "Practical technology knowledge kept together with evidence, freshness, and execution context.",
