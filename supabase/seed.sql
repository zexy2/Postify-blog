...
with editor as (
  ...
  values
    ('ai-muhendisligi', 'AI', '/images/posts/ai-muhendisligi.jpg', 7,
    ...
    ('web-standartlari', 'Web', '/images/posts/web-standartlari.jpg', 6,
    ...
    ('frontend-performansi', 'Frontend', '/images/posts/frontend-performansi.jpg', 8,
    ...
    ('urun-tasarimi', 'Ürün tasarımı', '/images/posts/urun-tasarimi.jpg', 7,
    ...
    ('edge-mimarileri', 'Altyapı', '/images/posts/edge-mimarileri.jpg', 6,
    ...
    ('gelistirici-akisi', 'Geliştirici araçları', '/images/posts/gelistirici-akisi.jpg', 5,
    ...
    ('teknik-yazarlik', 'İş akışı', '/images/posts/teknik-yazarlik.jpg', 5,
    ...
    ('urun-telemetrisi', 'Performans', '/images/posts/urun-telemetrisi.jpg', 7,
